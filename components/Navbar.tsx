  ...
  return (
    <header
      className={`sticky top-0 z-50 transition-all ${
        isScrolled
          ? "backdrop-blur bg-white/80 shadow-lg shadow-slate-200/50 border-b border-white/60"
          : "backdrop-blur bg-white/60 border-b border-white/40"
      }`}
    >
      <div className="container mx-auto py-3 md:py-4 px-4 md:px-6">
        <div className="flex justify-between items-center rounded-2xl border border-white/60 bg-white/70 px-4 py-3 shadow-sm shadow-slate-200/50">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2 z-10">
            <CloudUpload className="h-6 w-6 text-sky-600" />
            <h1 className="text-xl font-semibold text-slate-900">Droply</h1>
          </Link>
            ...
            <SignedOut>
              <Link href="/sign-in">
                <Button
                  variant="flat"
                  color="primary"
                  className="rounded-full bg-sky-50 text-sky-700 hover:bg-sky-100"
                >
                  Sign In
                </Button>
              </Link>
              <Link href="/sign-up">
                <Button
                  variant="solid"
                  color="primary"
                  className="rounded-full bg-gradient-to-r from-sky-500 to-indigo-600 font-semibold text-white shadow-lg shadow-sky-200/60"
                >
                  Sign Up
                </Button>
              </Link>
