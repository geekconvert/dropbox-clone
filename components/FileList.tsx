...
export default function FileList({
  ...
  return (
    <div className="space-y-6">
      ...
      <Divider className="my-4 border-white/60" />
      ...
      {filteredFiles.length === 0 ? (
        ...
        <Card
          shadow="sm"
          className="border border-white/60 bg-white/80 overflow-hidden shadow-lg shadow-slate-200/60 backdrop-blur-md"
        >
          <div className="overflow-x-auto">
            <Table
              ...
              selectionMode="none"
              classNames={{
                base: "min-w-full rounded-2xl bg-transparent",
                table: "rounded-2xl",
                thead: "bg-white/70 backdrop-blur-md",
                th: "text-slate-600 font-semibold text-xs uppercase tracking-[0.08em] border-b border-slate-100 py-3",
                tbody: "bg-white/60",
                tr: "transition hover:bg-slate-50/80",
